...
export function OdiseoOrbital() {
  ...
  const timelineData = [
    ...
    },
    {
      ...
      date: "Evaluación",
      content: "Escribís un tema, elegís cuántas preguntas y respondés un múltiple choice generado por IA. Al terminar recibís tu puntaje y una respuesta elaborada de Neville.",
      category: "Conversar",
      icon: Brain,
      relatedIds: [1, 6],
      status: "completed" as const,
    ...
    },
    {
      ...
      title: "Mi libro",
      date: "Tu proceso",
      content: "Escribís un tema y la IA genera un capítulo reflexivo desde las enseñanzas de Neville en primera persona. Editás, guardás y acumulás capítulos de tu propio libro.",
      category: "Mi espacio",
      icon: BookMarked,
      relatedIds: [5, 7],
      status: "completed" as const,
