...
export function QuickActions({ 
  ...
  const quickStats = [
    { label: "Today's Events", value: "3", color: "bg-[#E8401A]" },
    { label: "This Week", value: "12", color: "bg-neutral-500" },
    { label: "Pending", value: "2", color: "bg-[#E8401A]" }
  ]
        ...
        <CardContent className="space-y-3">
          <div className="space-y-2">
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-[#E8401A] rounded-full mt-2" />
