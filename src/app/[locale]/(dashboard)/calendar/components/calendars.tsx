...
const enhancedCalendars: CalendarGroup[] = [
  {
    name: "My Calendars",
    items: [
      { id: "personal", name: "Personal", color: "bg-[#E8401A]", visible: true, type: "personal" },
      { id: "work", name: "Work", color: "bg-neutral-800", visible: true, type: "work" },
      { id: "family", name: "Family", color: "bg-neutral-500", visible: true, type: "personal" }
    ]
  },
  {
    name: "Favorites",
    items: [
      { id: "holidays", name: "Holidays", color: "bg-[#E8401A]", visible: true, type: "shared" },
      { id: "birthdays", name: "Birthdays", color: "bg-neutral-400", visible: true, type: "personal" }
    ]
  },
  {
    name: "Other",
    items: [
      { id: "travel", name: "Travel", color: "bg-[#E8401A]", visible: false, type: "personal" },
      { id: "reminders", name: "Reminders", color: "bg-neutral-600", visible: true, type: "personal" },
      { id: "deadlines", name: "Deadlines", color: "bg-neutral-700", visible: true, type: "work" }
    ]
  }
]
