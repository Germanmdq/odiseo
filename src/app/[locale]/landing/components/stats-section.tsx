...
import { BookOpen, Users, FileText, MessageSquareText } from 'lucide-react'
...
export function StatsSection() {
  ...
  const stats = [
    ...
    { icon: MessageSquareText, value: t("stat4Value"), label: t("stat4Label"), description: t("stat4Desc") },
  ]
